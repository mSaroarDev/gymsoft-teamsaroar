        ...
        {currUserData?.role === "Admin" && (
          <>
            ...
            <StatsCard
              ...
              percent={"+10%"}
              icon={<FileUser className="w-7 h-7 text-white" />}
            />
            ...
            <StatsCard
              ...
              percent={"+0%"}
              icon={<ContactRound className="w-7 h-7 text-white" />}
            />
            ...
            <StatsCard
              ...
              percent={"+90%"}
              icon={<ClipboardPlus className="w-7 h-7 text-white" />}
            />
          </>
        )}
        ...
        {currUserData?.role === "Trainee" && (
          <>
            ...
            <StatsCard
              ...
              percent={"+0%"}
              icon={<OctagonAlert className="w-7 h-7 text-white" />}
            />
          </>
        )}
